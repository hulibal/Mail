           			...
           			%>
           				<li>
           					<a onclick="ajax(<%=mail.getId() %>)">
           						<span style='color:black'><%=mail.getAddresser() %></span>
           						<br/>
      ...
      <div class="col-md-9">
        <div id="display" class="bs-customizer" style="margin-bottom:100px;margin-top:30px">        
           				...
           				<%
           					if(eg != null){
           						...
           						%>
           							...
           							<a href="download?mailid=<%= eg.getId() %>&attachid=<%= a.getId()%>&box=inbox" ><%=a.getName()%></a><br/>
          ...
          <form action="delete" style="margin-top:30px">
          	<input name="box" value="inbox" type="hidden"/>
